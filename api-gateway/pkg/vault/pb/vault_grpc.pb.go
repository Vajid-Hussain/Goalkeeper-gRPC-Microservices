...
func (c *vaultServiceClient) CreateCollection(ctx context.Context, in *CreateCollectionRequest, opts ...grpc.CallOption) (*CreateCollectionRespose, error) {
	out := new(CreateCollectionRespose)
...
var VaultService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/vault/pb/vault.proto",
}
